...
urlpatterns = [
    ...
    path('core/', views.quiz_list, name='quiz_list'),
    path('core/<int:category_id>/', views.quiz_list, name='quiz_list_by_category'),
    ...
    path('api/admin/chart-data/', views.admin_dashboard_chart_api, name='admin_chart_api'),
]
