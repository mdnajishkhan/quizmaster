...
class Announcement(models.Model):
    title = models.CharField(max_length=200, help_text="Main heading (e.g., Happy New Year 2026!)")
    subtitle = models.CharField(max_length=200, blank=True, null=True, help_text="Subheading (e.g., Kickstart your journey...)")
    content = models.TextField(blank=True, null=True, help_text="Main body text, supports HTML for bolding etc.")
    
    highlighted_text = models.CharField(max_length=200, blank=True, null=True, help_text="Text shown in the highlighted pill/box")
    
    button_text = models.CharField(max_length=50, default="Show Me The Programs ⚡")
    button_link = models.CharField(max_length=200, default="/training/")
    
    is_active = models.BooleanField(default=False, help_text="Check this to show the popup to users.")
    
    AUDIENCE_CHOICES = [
        ('ALL', 'All Users'),
        ('VISITORS', 'Visitors/Newcomers (No Active Plan)'),
        ('STUDENTS', 'Active Students (Has Active Plan)'),
    ]
...
class Expense(models.Model):
    ...
    category = models.CharField(max_length=100, blank=True, null=True, help_text="e.g. Marketing, Server, Salary")
    description = models.TextField(blank=True, null=True)
...
class AdminDashboard(models.Model):
    """
    Dummy model to create a sidebar entry for 'Dashboard'
    """
    class Meta:
        verbose_name = 'Dashboard'
        verbose_name_plural = 'Dashboard'
        managed = False
        app_label = 'core'  # Ensure it appears in Core app
